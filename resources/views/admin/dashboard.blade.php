...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <ul class="list-inline">
                            <li>
                                <h6 class="text-muted text-success"><i class="fa fa-circle font-10 m-r-10 "></i>Ample
                                </h6></li>
                            <li>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <!-- Column -->
            <div class="card"><img class="" src="{{ asset('assets/admin/images/background/profile-bg.jpg') }}"
                                   alt="Card image cap">
                <div class="card-body little-profile text-center">
                    <div class="pro-img"><img src="{{ asset('assets/admin/images/users/4.jpg') }}" alt="user"/></div>
                ...
                <div class="card-body">
                    <div class="message-box contact-box">
                        ...
                        <div class="message-widget contact-widget">
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"><img src="{{ asset('assets/admin/images/users/1.jpg') }}"
                            ...
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"><img src="{{ asset('assets/admin/images/users/2.jpg') }}"
                                                           alt="user" class="img-circle"> <span
                            ...
                            <!-- Message -->
                            <a href="#">
                                <div class="user-img"><img src="{{ asset('assets/admin/images/users/4.jpg') }}"
                                                           alt="user" class="img-circle"> <span
            ...
            <div class="card">
                ...
                <div class="comment-widgets">
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="{{ asset('assets/admin/images/users/1.jpg') }}"
                    ...
                    <div class="d-flex flex-row comment-row active">
                        <div class="p-2"><span class="round"><img src="{{ asset('assets/admin/images/users/2.jpg') }}"
                                                                  alt="user" width="50"></span></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="{{ asset('assets/admin/images/users/3.jpg') }}"
                                                                  alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><span class="round"><img src="{{ asset('assets/admin/images/users/4.jpg') }}"
                                                                  alt="user" width="50"></span></div>
                        <div class="comment-text w-100">
                            <h5>James Anderson</h5>
                            <p class="m-b-5">Lorem Ipsum is simply dummy text of the printing and type setting industry.
                    ...
                    <div class="to-do-widget m-t-20">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="{{ asset('assets/admin/images/users/1.jpg') }}" alt="user"
                                             data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Steave"></li>
                                    <li><img src="{{ asset('assets/admin/images/users/2.jpg') }}" alt="user"
                                             data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Jessica"></li>
                                    <li><img src="{{ asset('assets/admin/images/users/3.jpg') }}" alt="user"
                                             data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Priyanka"></li>
                                    <li><img src="{{ asset('assets/admin/images/users/4.jpg') }}" alt="user"
                                             data-toggle="tooltip" data-placement="top" title=""
